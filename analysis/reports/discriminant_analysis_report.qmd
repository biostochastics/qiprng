...
- **Sample Size**: 10,000 random numbers per discriminant
- **MPFR Precision**: 128 bits (default)
- **Significance Level**: α = 0.05 for all statistical tests
- **Autocorrelation Lags**: Up to 20 lags tested
- **Spectral Analysis**: Full FFT with power ratio threshold of 3.0
