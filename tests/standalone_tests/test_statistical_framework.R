...
if (!exists("run_basic_tests")) {
  ...
  # Don't use assignInNamespace - just define the function in the global environment
  assign("run_basic_tests", run_basic_tests, envir = .GlobalEnv)
}
...
if (!exists("run_runs_tests")) {
  ...
  assign("run_runs_tests", run_runs_tests, envir = .GlobalEnv)
}
...
if (!exists("run_correlation_tests")) {
  ...
  assign("run_correlation_tests", run_correlation_tests, envir = .GlobalEnv)
}
...
if (!exists("run_binary_tests")) {
  ...
  assign("run_binary_tests", run_binary_tests, envir = .GlobalEnv)
}
...
if (!exists("run_classical_tests")) {
  ...
  assign("run_classical_tests", run_classical_tests, envir = .GlobalEnv)
}
...
if (!exists("run_compression_tests")) {
  ...
  assign("run_compression_tests", run_compression_tests, envir = .GlobalEnv)
}
...
if (!exists("run_external_tests")) {
  ...
  assign("run_external_tests", run_external_tests, envir = .GlobalEnv)
}
