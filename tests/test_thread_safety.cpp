    ...
    static bool run_tests() {
        ...
        std::cout << "\nTest 1: Multi-threaded generation..." << std::endl;
        {
            ...
            if (error_counter.load() == 0) {
                ...
                std::cout << "✗ Multi-threaded generation test failed with " 
                         << error_counter.load() << " errors" << std::endl;
                return false;
            }
        }
        ...
        std::cout << "\nTest 2: Rapid cleanup stress test..." << std::endl;
        {
            ...
            if (error_counter.load() == 0) {
                ...
                std::cout << "✗ Rapid cleanup test failed with " 
                         << error_counter.load() << " errors" << std::endl;
                return false;
            }
        }
        ...
        std::cout << "\nTest 3: Thread exit handling..." << std::endl;
        {
            ...
            if (error_counter.load() == 0) {
                ...
                std::cout << "✗ Thread exit handling test failed with " 
                         << error_counter.load() << " errors" << std::endl;
                return false;
            }
        }
