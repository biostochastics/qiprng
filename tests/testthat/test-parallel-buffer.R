...
test_that("Parallel buffer filling improves performance for large buffers", {
  ...
  skip_if(
    !interactive() && Sys.getenv("RUN_PERFORMANCE_TESTS") != "true",
