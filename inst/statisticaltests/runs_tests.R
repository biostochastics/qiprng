    ...
    tryCatch(
      {
        ...
        suite$results$runs$runs_test <- list(
          ...
          details = paste(
            "Tests if runs of values above/below median have expected length.",
    ...
    tryCatch(
      {
        ...
        suite$results$runs$turning_points <- list(
          ...
          details = paste(
            "Tests the number of turning points (local extrema) in the sequence.",
