...
run_basic_tests <- function(suite) {
  ...
  chi_test_result <- list(
    ...
    details = paste(
      "Tests if frequencies in", bins_count,
  ...
  mean_test_result <- list(
    ...
    statistic = z_mean,
    details = paste(
      "Tests if mean =", format(mean_x, digits = 6),
  ...
  variance_test_result <- list(
    ...
    statistic = chi_var,
    details = paste(
      "Tests if variance =", format(var_x, digits = 6),
  ...
  min_test_result <- list(
    ...
    statistic = min_x,
    details = paste(
      "Tests if minimum value =", format(min_x, digits = 6),
  ...
  max_test_result <- list(
    ...
    statistic = max_x,
    details = paste(
      "Tests if maximum value =", format(max_x, digits = 6),
