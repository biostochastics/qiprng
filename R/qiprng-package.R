...
#' quadratic irrationals with optional ChaCha20 output mixing.
#'
#' @details
...
#'   \item Optional ChaCha20 output mixing for enhanced statistical quality
#'   \item Deterministic/reproducible mode with seed support (v0.2.7)
