...
tryCatch(
  {
    ...
    test_files <- c(
      "basic_tests.R", "classical_tests.R", "binary_tests.R",
  ...
  tryCatch(
    {
      ...
      summary_df <- data.frame(
        ...
        p_value = sapply(results, function(r) {
          if (is.list(r) && "p_value" %in% names(r)) {
            r$p_value
          } else {
            NA
          }
        ...
        statistic = sapply(results, function(r) {
          if (is.list(r) && "statistic" %in% names(r)) {
        ...
        passed = sapply(results, function(r) {
          if (is.list(r) && "result" %in% names(r)) {
            r$result == "PASS"
          } else {
            FALSE
          }
        ...
        details = sapply(results, function(r) {
          if (is.list(r) && "description" %in% names(r)) {
            r$description
          } else {
            ""
          }
  ...
  tryCatch(
    {
      ...
      summary_df <- data.frame(
        ...
        details = sapply(results, function(r) {
          if (is.list(r) && "description" %in% names(r)) {
            r$description
          } else if (is.list(r) && "details" %in% names(r)) {
            r$details
          } else {
            ""
          }
    ...
    tryCatch(
      {
        ...
        summary_df <- data.frame(
          ...
          p_value = sapply(results, function(r) {
            if (is.list(r) && "p_value" %in% names(r)) {
              r$p_value
            } else if (is.list(r) && "p.value" %in% names(r)) {
              r$p.value
            } else {
              NA
            }
          ...
          statistic = sapply(results, function(r) {
            if (is.list(r) && "statistic" %in% names(r)) {
              r$statistic
            } else if (is.list(r) && "test_statistic" %in% names(r)) {
              r$test_statistic
            } else {
              NA
            }
          ...
          passed = sapply(results, function(r) {
            p <- if (is.list(r) && "p_value" %in% names(r)) {
              r$p_value
            } else if (is.list(r) && "p.value" %in% names(r)) {
              r$p.value
            } else {
    ...
    tryCatch(
      {
        ...
        summary_df <- data.frame(
          test = names(results),
          p_value = sapply(results, function(r) {
            if (is.list(r) && "p.value" %in% names(r)) {
              r$p.value
            } else if (is.list(r) && "p_value" %in% names(r)) {
              r$p_value
            } else {
              NA
            }
          ...
          passed = sapply(results, function(r) {
            p <- if (is.list(r) && "p.value" %in% names(r)) {
              r$p.value
            } else if (is.list(r) && "p_value" %in% names(r)) {
              r$p_value
            } else {
