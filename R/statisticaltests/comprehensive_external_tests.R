...
generate_test_report <- function(results, file = "external_tests_report.html",
  ...
  html <- c(
    ...
    paste0(
      "    <p><strong>Sample Size:</strong> ",
      format(results$metadata$sample_size, big.mark = ","), "</p>"
    ),
    paste0(
      "    <p><strong>Significance Level:</strong> ",
      results$metadata$alpha, "</p>"
    ),
    paste0(
      "    <p><strong>Packages Used:</strong> ",
  ...
  if (length(p_values) > 0) {
    html <- c(
      ...
      paste0(
        "    <p><strong>Mean p-value:</strong> ",
        sprintf("%.3f", mean(p_values)), "</p>"
      ),
      paste0(
        "    <p><strong>Median p-value:</strong> ",
        sprintf("%.3f", median(p_values)), "</p>"
      ),
      paste0(
        "    <p><strong>Min p-value:</strong> ",
        sprintf("%.4f", min(p_values)), "</p>"
      ),
      paste0(
        "    <p><strong>Max p-value:</strong> ",
    ...
    if (length(p_values) >= 8) {
      ...
      html <- c(
        html,
        paste0(
          "    <p><strong>KS test for uniformity:</strong> p = ",
