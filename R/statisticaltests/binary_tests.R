...
run_binary_tests <- function(suite) {
  ...
  if (length(bit_sequence) < 100) {
    suite$results$binary <- list(
      monobit = list(description = "Monobit Test", result = "INCONCLUSIVE", 
                     p_value = NA, details = "Insufficient data after NA removal"),
      block_frequency = list(description = "Block Frequency Test", result = "INCONCLUSIVE", 
                            p_value = NA, details = "Insufficient data after NA removal"),
      runs = list(description = "Runs Test", result = "INCONCLUSIVE", 
                  p_value = NA, details = "Insufficient data after NA removal"),
      longest_run = list(description = "Longest Run Test", result = "INCONCLUSIVE", 
                        p_value = NA, details = "Insufficient data after NA removal"),
      serial = list(description = "Serial Test", result = "INCONCLUSIVE", 
                   p_value = NA, details = "Insufficient data after NA removal"),
      approximate_entropy = list(description = "Approximate Entropy Test", result = "INCONCLUSIVE", 
                                p_value = NA, details = "Insufficient data after NA removal")
    )
    return(suite)
  }
  ...
  suite$results$binary$frequency_within_blocks <- list(
    ...
    details = paste("Tests if proportion of ones within blocks is close to 0.5.",
  ...
  suite$results$binary$cumulative_sums_forward <- list(
    ...
    details = paste("Tests maximum excursion of cumulative sum (forward).",
  ...
  suite$results$binary$cumulative_sums_backward <- list(
    ...
    details = paste("Tests maximum excursion of cumulative sum (backward).",
  ...
  suite$results$binary$random_excursions <- list(
    ...
    details = paste(excursions_result$message,
                   "| Cycles:", excursions_result$cycles,
  ...
  suite$results$binary$random_excursions_variant <- list(
    ...
    details = paste(excursions_var_result$message,
  ...
  suite$results$binary$linear_complexity <- list(
    ...
    details = paste(linear_result$message,
  ...
  suite$results$binary$approximate_entropy <- list(
    ...
    details = paste(approx_entropy_result$message,
