...
Full validation report and test results are available in [`validation/NIST_VALIDATION.md`](validation/NIST_VALIDATION.md),
with complete test outputs preserved in [`validation/nist_sts/`](validation/nist_sts/).
