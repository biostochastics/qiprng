...
__global__ void qi_generate_kernel(double* output, const double* params, size_t n,
...
class CUDAAccelerator {
   ...
   public:
    ...
    // Generate on GPU
    void generate(double* host_buffer, size_t size, double a, double b, double c,
                  unsigned long long seed) {
...
class AVX2Accelerator {
   public:
    ...
    static void cf_evaluate_batch(double* result, const double* convergents, size_t n, int depth) {
...
class HardwareAccelerationManager {
   ...
   public:
    ...
    enum AccelMethod { NONE, OPENMP, CUDA, AVX2, NEON };
